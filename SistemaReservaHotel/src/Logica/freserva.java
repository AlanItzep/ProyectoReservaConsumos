...
public DefaultTableModel mostrar(String buscar){
    ...
    String [] registro = new String [13];
        ...
        sSQL="select r.idreserva,r.idhabitacion,h.numero,"+ 
                "r.idcliente,(select nombre from persona where idpersona=r.idcliente)as clienten,"+
                ...
                "r.costo_alojamiento,r.estado from reserva r inner join habitacion h on r.idhabitacion=h.idhabitacion where r.fecha_reserva like '%"+ 
