...
public DefaultTableModel mostrar(String buscar){
    ...
    String [] registro = new String [14];
        ...
        sSQL = "select p.idpersona,p.nombre,p.apellido_paterno,p.apellido_materno,p.tipo_documento,p.numero_documento,"
...
public boolean insertar(vtrabajador dts){
    sSQL = "insert into persona (nombre,apellido_paterno,apellido_materno,tipo_documento,numero_documento,direccion,telefono,email)"
            +"values(?,?,?,?,?,?,?,?)";
...
public boolean editar(vtrabajador dts){
    sSQL = "update persona set nombre=?, apellido_paterno=?, apellido_materno=?,tipo_documento=?,numero_documento=?,"
...
public DefaultTableModel login(String login, String password){
    ...
    String [] registro = new String [8];
        ...
        sSQL = "select p.idpersona,p.nombre,p.apellido_paterno,p.apellido_materno,"
